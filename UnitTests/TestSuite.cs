...
namespace UnitTests
{
    ...
    public class DataContractJsonTestSuite : TestSuiteBase
    {
        public DataContractJsonTestSuite()
            : base(new Jose.JWT(new DataContractMapper()))
        {
        }
    }
    public class WebJsonTestSuite : TestSuiteBase
    {
        public WebJsonTestSuite()
            : base(new Jose.JWT(new JsSerializerMapper()))
        {
        }
        ...
        public void EncodePlaintext()
        {
            ...
            //when
            string hashed = toTest.Encode(payload, null, JwsAlgorithm.none);
        ...
        public void Encrypt_RSA1_5_A256CBC_HS512()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A256CBC_HS512);
            ...
            Assert.That(toTest.Decode(token, PrivKey()), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_RSA_OAEP_A192CBC_HS384()
        {
            ...
            //when
            string token = toTest.Encode(payload, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A192CBC_HS384);
        ...
        public void Encrypt_RSA_OAEP_A256CBC_HS512()
        {
            ...
            //when            
            string token = toTest.Encode(payload, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A256CBC_HS512);
        ...
        public void Encrypt_RSA1_5_A192CBC_HS384()
        {
            ...
            //when
            string token = toTest.Encode(payload, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A192CBC_HS384);
    ...
    public abstract class TestSuiteBase
    {
        ...
        protected TestSuiteBase(Jose.JWT instance)
        {
            toTest = instance;
        }

        protected readonly Jose.JWT toTest;
        [SetUp]
        public void SetUp() {}
        ...
        public void DecodePlaintext()
        {
            ...
            //when
            var test = toTest.Decode<IDictionary<string, object>>(token);
        ...
        public void DecodeHS256()
        {
            ...
            Arrays.Dump(bytes);
            string json = toTest.Decode(token, bytes);
        ...
        public void DecodeHS384()
        {
            ...
            //when
            string json = toTest.Decode(token, Encoding.UTF8.GetBytes(key));
        ...
        public void DecodeRS256()
        {
            ...
            //when
            string json = toTest.Decode(token, PubKey());
        ...
        public void DecodeES256()
        {
            ...
            //when
            string json = toTest.Decode(token, Ecc256Public());
        ...
        public void DecodeES384()
        {
            ...
            //when
            string json = toTest.Decode(token, Ecc384Public());
        ...
        public void DecodeES512()
        {
            ...
            //when
            string json = toTest.Decode(token, Ecc512Public());
        ...
        public void EncodePS256()
        {
            ...
            //when
            string token = toTest.Encode(json, PrivKey(), JwsAlgorithm.PS256);
            ...
            Assert.That(toTest.Decode(token,PubKey()),Is.EqualTo(json),"Make sure we are consistent with ourselves");
        }
        ...
        public void EncodePS384()
        {
            ...
            //when
            string token = toTest.Encode(json, PrivKey(), JwsAlgorithm.PS384);
        ...
        public void EncodePS512()
        {
            ...
            //when
            string token = toTest.Encode(json, PrivKey(), JwsAlgorithm.PS512);
        ...
        public void EncodeHS256()
        {
            ...
            //when
            string token=toTest.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS256);
            ...
            Assert.That(toTest.Decode(token, Encoding.UTF8.GetBytes(key)), Is.EqualTo(json), "Make sure we are consistent with ourselves");
        }
        ...
        public void EncodeHS384()
        {
            ...
            //when
            string token = toTest.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS384);
        ...
        public void EncodeHS512()
        {
            ...
            //when
            string token = toTest.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS512);
        ...
        public void EncodeRS256()
        {
            ...
            //when
            string test=toTest.Encode(json, PrivKey(), JwsAlgorithm.RS256);
            ...
            Assert.That(toTest.Decode(test,PubKey()),Is.EqualTo(json),"Make sure we are consistent with outselfs.");
        }
        ...
        public void EncodeRS384()
        {
            ...
            //when
            string token=toTest.Encode(json, PrivKey(), JwsAlgorithm.RS384);
        ...
        public void EncodeRS512()
        {
            ...
            //when
            string token=toTest.Encode(json, PrivKey(), JwsAlgorithm.RS512);
        ...
        public void EncodeES256()
        {
            ...
            //when
            string token=toTest.Encode(json, Ecc256Private(), JwsAlgorithm.ES256);
            ...
            Assert.That(toTest.Decode(token, Ecc256Public()), Is.EqualTo(json), "Make sure we are consistent with ourselves");
        }
        ...
        public void EncodeES384()
        {
            ...
            //when
            string token=toTest.Encode(json, Ecc384Private(), JwsAlgorithm.ES384);
            ...
            Assert.That(toTest.Decode(token, Ecc384Public()), Is.EqualTo(json), "Make sure we are consistent with ourselves");
        }
        ...
        public void EncodeES512()
        {
            ...
            //when
            string token=toTest.Encode(json, Ecc512Private(), JwsAlgorithm.ES512);
            ...
            Assert.That(toTest.Decode(token, Ecc512Public()), Is.EqualTo(json), "Make sure we are consistent with ourselves");
        }
        ...
        public void Decrypt_RSA_OAEP_A128CBC_HS256()
        {
            ...
            //when
            string json = toTest.Decode(token,PrivKey());
        ...
        public void Encrypt_RSA_OAEP_256_A128GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP_256, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA_OAEP_256_A192GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP_256, JweEncryption.A192GCM);
        ...
        public void Encrypt_RSA_OAEP_256_A256GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP_256, JweEncryption.A256GCM);
        ...
        public void Encrypt_RSA_OAEP_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_RSA1_5_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_RSA_OAEP_A128GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA_OAEP_A192GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A192GCM);
        ...
        public void Encrypt_RSA_OAEP_A256GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A256GCM);
        ...
        public void Encrypt_RSA_OAEP_A256GCM_DEFLATE()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A256GCM, JweCompression.DEF);
        ...
        public void Encrypt_RSA1_5_A128GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA1_5_A192GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A192GCM);
        ...
        public void Encrypt_RSA1_5_A256GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A256GCM);
        ...
        public void Decrypt_DIR_A128GCM()
        {
            ...
            //when
            string json = toTest.Decode(token, aes128Key);
        ...
        public void Decrypt_DIR_A192GCM()
        {
            ...
            //when
            string json = toTest.Decode(token, aes192Key);
        ...
        public void Decrypt_DIR_A256GCM()
        {
            ...
            //when
            string json = toTest.Decode(token, aes256Key);
        ...
        public void Decrypt_ECDH_ES_A128CBC_HS256()
        {
            ...
            //when
            string json = toTest.Decode(token, Ecc256Private(CngKeyUsages.KeyAgreement));
        ...
        public void Decrypt_PBSE2_HS256_A128KW_A128CBC_HS256()
        {
            ...
            //when
            string json = toTest.Decode(token, "top secret");
        ...
        public void Encrypt_PBES2_HS256_A128KW_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, "top secret", JweAlgorithm.PBES2_HS256_A128KW, JweEncryption.A128CBC_HS256);
            ...
            Assert.That(toTest.Decode(token, "top secret"), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_PBES2_HS256_A128KW_A256GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, "top secret", JweAlgorithm.PBES2_HS256_A128KW, JweEncryption.A256GCM);
        ...
        public void Encrypt_PBES2_HS384_A192KW_A192GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, "top secret", JweAlgorithm.PBES2_HS384_A192KW, JweEncryption.A192GCM);
        ...
        public void Encrypt_PBES2_HS512_A256KW_A256CBC_HS512()
        {
            ...
            //when
            string token = toTest.Encode(json, "top secret", JweAlgorithm.PBES2_HS512_A256KW, JweEncryption.A256CBC_HS512);
        ...
        public void Encrypt_A128GCMKW_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, aes128Key, JweAlgorithm.A128GCMKW, JweEncryption.A128CBC_HS256);
            ...
            Assert.That(toTest.Decode(token, aes128Key), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_A128GCMKW_A256CBC_HS512()
        {
            ...
            //when
            string token = toTest.Encode(json, aes128Key, JweAlgorithm.A128GCMKW, JweEncryption.A256CBC_HS512);
        ...
        public void Encrypt_A192GCMKW_A192CBC_HS384()
        {
            ...
            //when
            string token = toTest.Encode(json, aes192Key, JweAlgorithm.A192GCMKW, JweEncryption.A192CBC_HS384);
            ...
            Assert.That(toTest.Decode(token, aes192Key), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_A256GCMKW_A256CBC_HS512()
        {
            ...
            //when
            string token = toTest.Encode(json, aes256Key, JweAlgorithm.A256GCMKW, JweEncryption.A256CBC_HS512);
            ...
            Assert.That(toTest.Decode(token, aes256Key), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_A128KW_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, aes128Key, JweAlgorithm.A128KW, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_ECDH_ES_A128KW_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES_A128KW, JweEncryption.A128CBC_HS256);
            ...
            Assert.That(toTest.Decode(token, Ecc256Private(CngKeyUsages.KeyAgreement)), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_ECDH_ES_A192KW_A192GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES_A192KW, JweEncryption.A192GCM);
        ...
        public void Encrypt_ECDH_ES_A256KW_A256GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES_A256KW, JweEncryption.A256GCM);
        ...
        public void Encrypt_ECDH_ES_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_ECDH_ES_A128GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A128GCM);
        ...
        public void Encrypt_ECDH_ES_A192GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A192GCM);
        ...
        public void Encrypt_ECDH_ES_A256GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A256GCM);
        ...
        public void Encrypt_A192KW_A192CBC_HS384()
        {
            ...
            //when
            string token = toTest.Encode(json, aes192Key, JweAlgorithm.A192KW, JweEncryption.A192CBC_HS384);
        ...
        public void Encrypt_A256KW_A256CBC_HS512()
        {
            ...
            //when
            string token = toTest.Encode(json, aes256Key, JweAlgorithm.A256KW, JweEncryption.A256CBC_HS512);
        ...
        public void Decrypt_DIR_A192CBC_HS384()
        {
            ...
            //when
            string json = toTest.Decode(token, aes384Key);
        ...
        public void Decrypt_DIR_A256CBC_HS512()
        {
            ...
            //when
            string json = toTest.Decode(token, aes512Key);
        ...
        public void Encrypt_DIR_A128GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, aes128Key, JweAlgorithm.DIR, JweEncryption.A128GCM);
        ...
        public void Encrypt_DIR_A256GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, aes256Key, JweAlgorithm.DIR, JweEncryption.A256GCM);
        ...
        public void Encrypt_DIR_A192GCM()
        {
            ...
            //when
            string token = toTest.Encode(json, aes192Key, JweAlgorithm.DIR, JweEncryption.A192GCM);
        ...
        public void Encrypt_DIR_A128CBC_HS256()
        {
            ...
            //when
            string token = toTest.Encode(json, aes256Key, JweAlgorithm.DIR, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_DIR_A192CBC_HS384()
        {
            ...
            //when
            string token = toTest.Encode(json, aes384Key, JweAlgorithm.DIR, JweEncryption.A192CBC_HS384);
            ...
            Assert.That(toTest.Decode(token, aes384Key), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_DIR_A256CBC_HS512()
        {
            ...
            //when
            string token = toTest.Encode(json, aes512Key, JweAlgorithm.DIR, JweEncryption.A256CBC_HS512);
            ...
            Assert.That(toTest.Decode(token, aes512Key), Is.EqualTo(json), "Make sure we are consistent with ourselfs");
        }
        ...
        public void Encrypt_DIR_A256CBC_HS512_DEFLATE()
        {
            ...
            //when
            string token = toTest.Encode(json, aes512Key, JweAlgorithm.DIR, JweEncryption.A256CBC_HS512, JweCompression.DEF);
        ...
        protected RSACryptoServiceProvider PrivKey()
        {
        ...
        protected RSACryptoServiceProvider PubKey()
        {
